 ...
 * Обеспечивает загрузку, сохранение и доступ к различным параметрам
 * конфигурации.
 */
public final class fluffyConfig {
  ...
  private static final String KEY_MENU_FORWARD_WO_AUTHOR_ENABLED =
      "menu_forward_wo_author_enabled";
  private static final String KEY_MENU_JSON_VIEWER_ENABLED =
      "menu_json_viewer_enabled";
  private static final String KEY_MENU_CLEAR_CACHE_ENABLED =
      "menu_clear_cache_enabled";
  ...
  private static final String KEY_FORMAT_TIME_WITH_SECONDS =
  ...
  private static final String KEY_UNMUTE_VIDEO_WITH_VOLUME =
      "unmuteVideoWithVolume";
  ...
  private static final String KEY_SHOW_FORWARD_WO_AUTHORSHIP =
      "showForwardWoAuthorship";
  private static final String KEY_SHOW_VIEW_MESSAGE_FROM_USER =
      "showViewMessageFromUser";
  ...
  public static void load() {
    ...
    menuForwardWoAuthorEnabled =
        preferences.getBoolean(KEY_MENU_FORWARD_WO_AUTHOR_ENABLED, true);
    menuJsonViewerEnabled =
        preferences.getBoolean(KEY_MENU_JSON_VIEWER_ENABLED, false);
    menuClearFromCacheEnabled =
        preferences.getBoolean(KEY_MENU_CLEAR_CACHE_ENABLED, true);
    ...
    downloadSpeedBoost =
        preferences.getBoolean(KEY_DOWNLOAD_SPEED_BOOST, false);
    ...
    unmuteVideoWithVolume =
        preferences.getBoolean(KEY_UNMUTE_VIDEO_WITH_VOLUME, true);
    ...
    disableRoundingNumber =
        preferences.getBoolean(KEY_DISABLE_ROUNDING_NUMBER, false);
    formatTimeWithSeconds =
        preferences.getBoolean(KEY_FORMAT_TIME_WITH_SECONDS, false);
    ...
    doubleTapInAction = preferences.getInt(KEY_DOUBLE_TAP_IN_ACTION,
                                           DOUBLE_TAP_ACTION_REACTION);
    doubleTapOutAction = preferences.getInt(KEY_DOUBLE_TAP_OUT_ACTION,
                                            DOUBLE_TAP_ACTION_REACTION);
    saveDeletedMessages =
        preferences.getBoolean(KEY_SAVE_DELETED_MESSAGES, false);
    saveEditedMessages =
        preferences.getBoolean(KEY_SAVE_EDITED_MESSAGES, false);
    ...
    showForwardWoAuthorship =
        preferences.getBoolean(KEY_SHOW_FORWARD_WO_AUTHORSHIP, true);
    showViewMessageFromUser =
        preferences.getBoolean(KEY_SHOW_VIEW_MESSAGE_FROM_USER, true);
  ...
  public static void toggleSaveDeletedMessages() {
    saveDeletedMessages =
        toggleBooleanSetting(KEY_SAVE_DELETED_MESSAGES, saveDeletedMessages);
  }

  public static void toggleSaveEditedMessages() {
    saveEditedMessages =
        toggleBooleanSetting(KEY_SAVE_EDITED_MESSAGES, saveEditedMessages);
  }

  public static void toggleAllowAttachAnyBot() {
    allowAttachAnyBot =
        toggleBooleanSetting(KEY_ALLOW_ATTACH_ANY_BOT, allowAttachAnyBot);
  }
  ...
  public static void toggleHideButtonWrite() {
    hideButtonWrite =
        toggleBooleanSetting(KEY_HIDE_BUTTON_WRITE, hideButtonWrite);
  }

  public static void toggleShouldNotTrustMe() {
    shouldNOTTrustMe =
        toggleBooleanSetting(KEY_SHOULD_NOT_TRUST_ME, shouldNOTTrustMe);
  }
  ...
  public static void toggleUnmuteVideoWithVolume() {
    unmuteVideoWithVolume = toggleBooleanSetting(KEY_UNMUTE_VIDEO_WITH_VOLUME,
                                                 unmuteVideoWithVolume);
  }

  public static void togglePauseMusicOnMedia() {
    pauseMusicOnMedia =
        toggleBooleanSetting(KEY_PAUSE_MUSIC_ON_MEDIA, pauseMusicOnMedia);
  }

  public static void toggleDownloadSpeedBoost() {
    downloadSpeedBoost =
        toggleBooleanSetting(KEY_DOWNLOAD_SPEED_BOOST, downloadSpeedBoost);
  }
  ...
  public static void toggleCenterTitleInChat() {
    centerTitleInChat =
        toggleBooleanSetting(KEY_CENTER_TITLE_IN_CHAT, centerTitleInChat);
  }
  public static void toggleRoundingNumber() {
    disableRoundingNumber = toggleBooleanSetting(KEY_DISABLE_ROUNDING_NUMBER,
                                                 disableRoundingNumber);
  }

  public static void toggleFormatTimeWithSeconds() {
    formatTimeWithSeconds = toggleBooleanSetting(KEY_FORMAT_TIME_WITH_SECONDS,
                                                 formatTimeWithSeconds);
  }
  ...
  public static void toggleShowForwardWoAuthorship() {
    showForwardWoAuthorship = toggleBooleanSetting(
        KEY_SHOW_FORWARD_WO_AUTHORSHIP, showForwardWoAuthorship);
  }

  public static void toggleShowViewMessageFromUser() {
    showViewMessageFromUser = toggleBooleanSetting(
        KEY_SHOW_VIEW_MESSAGE_FROM_USER, showViewMessageFromUser);
  }
  ...
  public static String getUsername() {
    ...
    return !TextUtils.isEmpty(publicUsername) ? publicUsername
   ...
   */
  public static boolean useCloudFlare() { return voiceUseCloudflare == 1; }
  ...
  public static void toggleIdInWallpaperChat(long id) {
    ...
    List<String> ids =
        new ArrayList<>(Arrays.asList(idHideWallpaper.split(";")));
   ...
   */
  private static boolean toggleBooleanSetting(String key,
