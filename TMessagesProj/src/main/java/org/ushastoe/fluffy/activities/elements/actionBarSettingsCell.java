...
public class actionBarSettingsCell extends FrameLayout {
  ...
  public actionBarSettingsCell(Context context) {
    ...
    subtitleTextView.setTypeface(
        AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
  ...
  public void setText(String text) { titleTextView.setText(text); }

  public void setSubtitle(String text) { subtitleTextView.setText(text); }
