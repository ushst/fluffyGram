...
public class StickerBlacklistActivity extends BaseFragment {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        descriptions.add(new ThemeDescription(listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{TextCell.class}, null, null, null, Theme.key_windowBackgroundWhite));
