...
public class FluffySettingsActivity extends BaseFragment {
    ...
    private void updateItems() {
        ...
        items.add(new ItemInner(VIEW_TYPE_TEXT, ROW_GITHUB, LocaleController.getString(R.string.FluffyGitHub), "github.com/ushst/fluffyGram (v21)", R.drawable.msg_link2));
        if (adapter != null) {
