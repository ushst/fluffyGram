...
public final class SecretSettingsHelper {
    ...
    /**
     * Проверяет код доступа как Base64-подпись (SHA256withRSA) строки userId.
     * Ожидается, что строка кодируется без переносов; неверный формат приведёт к
     * ошибке декодирования и возврату false.
     */
