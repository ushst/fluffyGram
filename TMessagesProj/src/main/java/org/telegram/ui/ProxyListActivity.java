            ...
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_TEXT_CHECK: {
                    ...
                    if (position == useProxyRow) {
                        ...
                        checkCell.setTextAndCheck(getString(R.string.FluffyMediaProxyOnly), MediaOnlyProxySettingsHook.isEnabled(), true);
                    } else if (position == rotationRow) {
                ...
                case VIEW_TYPE_INFO: {
                    ...
                    if (position == callsDetailRow) {
                        ...
                        cell.setText(getString(R.string.FluffyMediaProxyOnlyInfo));
                        ...
                        cell.setText(getString(R.string.ProxyRotationThresholdInfo));
                    }
                    break;
                }
