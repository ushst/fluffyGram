...
//        }
        ...
        if (hasAddAccount) {
            ...
            items.add(InfoCell.Factory.of(BUTTON_ADD_ACCOUNT, R.drawable.outline_add_account, "Add Account", null, 0).accent());
        }
...
//            }));
    ...
    private static class InfoCell extends LinearLayout {
        ...
        public static class Factory extends UItem.UItemFactory<InfoCell> {
            ...
            @Override
            public InfoCell createView(Context context, int currentAccount, int classGuid, Theme.ResourcesProvider resourcesProvider) {
